...
import actions from '../../store/action/session'
 class NewAccount extends Component{
    handledet=()=>{
        ...
        this.props.det({username,password,email});
    };
    render(){
        return (
            <div className="lasts">
                    <p className="NewA">创建新账户</p>
                    <input ref={input=>this.username=input} className="Names" type="text" placeholder="姓名*"/>
                    <input ref={input=>this.email=input}  className="AddressDescription" type="password" placeholder="电邮地址*"/>
